...
<head>
    ...
    <title>MONETAG ADS | MR SORIF</title>
    ...
    <script src='//niphaumeenses.net/vignette.min.js' data-zone='8610253' data-sdk='show_8610253'></script>
...
<body>
    ...
    <html lang="en" data-fp="lmdx3nboc5"><head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <meta name="google-adsense-platform-account" content="ca-host-pub-0000000000000">
    <meta name="google-adsense-platform-domain" content="blogspot.com">
    <script async="" src="https://tzegilo.com/stattag.js"></script></head>
    <body data-new-gr-c-s-check-loaded="14.1209.0" data-gr-ext-installed="">
        <div class="container">
            <h1>Auto MoneTag Ads</h1>
            <div class="developer" onclick="window.location.href='https://t.me/shoriful500'">Developer by MD SORIF</div>
            
            <!-- Display User Info -->
            <div class="user-info">
                <p>Welcome, <span id="user-name">@shoriful500</span></p>
            </div>
        ...
        <script>
            ...
            const ADMIN_USER_ID = 6693287384;
            const BOT_TOKEN = "7055226175:AAF4RmUFVaeJgxVTDxvSC_DSB5QZUVpLGas";
            let watchedAdsCount = 0;
            let earnedPoints = 0.00;
            let autoAdInterval;
    
            // Simulate user name from Telegram User ID (replace with actual logic to get user info)
            const telegramUserName = "@shoriful500"; // Replace this line with the actual logic to fetch username
            ...
            function watchAd() {
                if (typeof show_8610253 === 'function') {
                    show_8610253().then(() => {
            ...
            function sendWithdrawRequestToAdmin(message) {
                fetch(`https://api.telegram.org/bot${7055226175:AAF4RmUFVaeJgxVTDxvSC_DSB5QZUVpLGas}/sendMessage?chat_id=${6693287384}&text=${encodeURIComponent(message)}`)
